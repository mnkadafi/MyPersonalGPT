...
struct MessageRowView_Previews: PreviewProvider {
  static let message = MessageRow(isInteractingWithChatGPT: false,
                                  sendImage: "profile",
                                  sendText: "What is SwiftUI?",
                                  responseImage: "openai",
                                  responseText: "SwiftUI is user interface framework that allows developers to design and develop user interfaces for iOS, MacOS, TvOS using Swift, a programming language developed by Apple Inc.")
